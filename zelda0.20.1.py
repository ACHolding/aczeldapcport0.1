...
FPS = 60
TILE = 16
TITLE = "AC's Tiny Cap Adventure 0.2 — GBA Speed"
...
class Game:
    def __init__(self) -> None:
        ...
        self.font = PixelFont(1, 1)
        self.font_small = PixelFont(1, 0)
        self.font_big = PixelFont(2, 2)
    ...
    def draw_hud(self, surface: pygame.Surface) -> None:
        ...
        if self.has_key:
            self.draw_text(surface, "KEY", (116, 4), COLORS["cream"], self.font_small)
        mode = "MINI" if self.player.tiny else "HERO"
        self.draw_text(surface, mode, (140, 4), (126, 223, 255), self.font_small)
    ...
    def render_world(self) -> None:
        ...
        if boss:
            ...
            self.draw_text(self.canvas, "EMBERHEART", (120, 29), COLORS["cream"], self.font_small, True)
    ...
    def render_title(self) -> None:
        ...
        self.draw_text(self.canvas, "TINY CAP", (120, 19), COLORS["cream"], self.font_big, True)
        ...
        self.draw_text(self.canvas, "240X160 | 60 FPS | CC0 ART", (120, 145), (137, 220, 213), self.font_small, True)
